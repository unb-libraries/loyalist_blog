...
/**
 * @file
 * loyalist_blog.strongarm.inc
 */

/**
 * Implements hook_strongarm().
 */
function loyalist_blog_strongarm() {
  $export = array();

  $strongarm = new stdClass();
  $strongarm->disabled = FALSE; /* Edit this to true to make a default strongarm disabled initially */
  $strongarm->api_version = 1;
  $strongarm->name = 'botcha_enabled_comment_node_blog_form';
  $strongarm->value = 1;
  $export['botcha_enabled_comment_node_blog_form'] = $strongarm;
  ...
  $strongarm->disabled = FALSE; /* Edit this to true to make a default strongarm disabled initially */
  $strongarm->api_version = 1;
  $strongarm->name = 'readmorecontrol_behaviour__node__blog';
  $strongarm->value = 'when_required_body';
  $export['readmorecontrol_behaviour__node__blog'] = $strongarm;

  $strongarm = new stdClass();
  $strongarm->disabled = FALSE; /* Edit this to true to make a default strongarm disabled initially */
  $strongarm->api_version = 1;
  $strongarm->name = 'readmorecontrol_behaviour__node__blog__teaser';
  $strongarm->value = 'when_required_body';
  $export['readmorecontrol_behaviour__node__blog__teaser'] = $strongarm;
  ...
  $strongarm->disabled = FALSE; /* Edit this to true to make a default strongarm disabled initially */
  $strongarm->api_version = 1;
  $strongarm->name = 'readmorecontrol_format__node__blog';
  $strongarm->value = array(
    'enabled' => 'custom',
  ...
  $export['readmorecontrol_format__node__blog'] = $strongarm;

  $strongarm = new stdClass();
  $strongarm->disabled = FALSE; /* Edit this to true to make a default strongarm disabled initially */
  $strongarm->api_version = 1;
  $strongarm->name = 'readmorecontrol_format__node__blog__teaser';
  $strongarm->value = array(
    'enabled' => 'custom',
    'text' => 'Continue Reading »',
    'href' => '',
    ...
    'rel' => '',
    'target' => '',
    'placement' => 'body_inline',
  );
  $export['readmorecontrol_format__node__blog__teaser'] = $strongarm;
